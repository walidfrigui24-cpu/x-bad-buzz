...
try:
    ...
    HF_API_KEY = None # Sera notifié à l'utilisateur

API_URL_SENTIMENT = "https://api-inference.huggingface.co/models/cardiffnlp/twitter-xlm-roberta-base-sentiment"

def query_huggingface_api(payload):
    """Envoi des données aux serveurs HF pour analyse (Zero RAM usage)."""
    if not HF_API_KEY: return {"error": "Clé manquante"}
...
with st.sidebar:
    ...
    # Vérification des clés avant de commencer
